    ...
    def __call__(self, sample):
        ...
        if self.__resize_target:
            ...
            if "semseg_mask" in sample:
                ...
                # )
                sample["semseg_mask"] = F.interpolate(torch.from_numpy(sample["semseg_mask"])[None, None, ...], (height, width), mode='nearest').numpy()[0, 0]
...
class PrepareForNet(object):
    ...
    def __call__(self, sample):
        ...
        if "semseg_mask" in sample:
            sample["semseg_mask"] = sample["semseg_mask"].astype(np.uint8)
